...
namespace get3D2DCorrespondance{
    ...
    correspondance get_correspondace(std::vector<cv::DMatch>& filtered_matches, std::vector<cv::KeyPoint>& kp_current, std::vector<cv::DMatch>& prev_2D_filtered_matches, std::vector<cv::Point3f>& prev_3D_points){
        ...
        std::vector<cv::Point3f> common_3d_pts;
